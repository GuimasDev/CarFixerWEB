...
export const Add_Veiculo = () => {
	...
	return (
		<Container id="container">
			<h1>{id !== undefined ? "Editar Veículo" : "Novo Veículo"}</h1>
			<Form id="form">
				<Row>
					<Col>
						<Input
							...
							value={modelo}
							onChange={(e: React.ChangeEvent<HTMLInputElement>) => setModelo((e.target as any).value)}
						/>
					</Col>
					...
					<Col>
						<Input
							...
							value={placa}
							onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPlaca((e.target as any).value)}
						/>
					</Col>
				</Row>
				...
				<Row>
					<Col>
						<Select
							...
							name="tipo"
							label="Tipo"
							defaultValue={id !== undefined ? undefined : "Informe o tipo do veículo"}
							value={tipo}
							onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTipo((e.target as any).value)}
						>
					...
					<Col>
						{userType === "Admin" ? (
							<Select
								...
								value={id_cliente}
								onChange={(e: React.ChangeEvent<HTMLInputElement>) => setId_Cliente((e.target as any).value)}
							>
								{clientes.map((cliente) =>
