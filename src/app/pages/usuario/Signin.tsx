	...
	return (
		<Container className={styles.container}>
			...
			{/* <div id="buttons">
                <Col>
                    <Row>
                        <Button form="form" className='cadastrarButton' onClick={handleSubmit} type="button" size="lg" variant="success">Cadastrar</Button>
                    </Row>
                    <Row>
			...
			<div className={styles.buttonArea}>
				<button className={styles.button} form="form" onClick={handleSubmit} type="button">
					Cadastrar
				</button>
			</div>
